...
const HERO_IMAGE = fondoFarmacia
const HISTORIA_IMAGE = farmaceutica
  ...
  return (
    <>
      ...
      <section className="relative h-80 md:h-96 w-full flex items-end overflow-hidden" aria-labelledby="nosotros-hero-title">
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-10" aria-hidden="true" />
        <div className="absolute inset-0 bg-main-dark/20 mix-blend-multiply z-0" aria-hidden="true" />
        {/* Imagen fondo */}
        <div
          className="absolute inset-0 w-full h-full bg-cover bg-center"
          style={{ backgroundImage: `url('${HERO_IMAGE}')` }}
          role="img"
          aria-label="Fachada de Rodyna Farmacias"
        />
        <div className="container-page relative z-20 pb-12">
          ...
          <h1 id="nosotros-hero-title" className="text-white text-4xl md:text-6xl font-black leading-tight tracking-tighter max-w-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-5">
              ...
              <p className="text-secondary-gray leading-relaxed">
                En Rodyna Farmacias, nuestra trayectoria comenzó con una visión simple: humanizar la atención farmacéutica. Fundada bajo el compromiso de brindar no solo medicamentos, sino bienestar integral a nuestra comunidad, crecimos junto a las familias del barrio durante más de treinta años.
              </p>
              <p className="text-secondary-gray leading-relaxed">
                Hoy contamos con cuatro sucursales en Buenos Aires — Caseros, Liniers, Almagro y Palermo — cada una con el mismo espíritu de servicio cercano, profesional y humano que nos dio origen.
              </p>
            </div>
      ...
      <section className="py-16 lg:py-20 bg-slate-50" aria-labelledby="valores-title">
        <div className="container-page">
          <div className="text-center mb-14">
            <h2 id="valores-title" className="text-3xl font-bold text-main-dark mb-3">Nuestros Valores Profesionales</h2>
            <p className="text-secondary-gray max-w-xl mx-auto">Los pilares que sostienen nuestro compromiso con vos.</p>
          </div>
        ...
        <div className="container-page max-w-5xl">
          <div className="text-center mb-14 space-y-3">
            ...
            <p className="text-secondary-gray text-lg max-w-2xl mx-auto">
              Nuestra misión no es solo dispensar fármacos, sino ser el puente hacia una vida más plena, saludable y digna para cada vecino que cruza nuestras puertas.
            </p>
          </div>
      ...
      <section className="py-14 bg-main-dark text-white" aria-label="Visitanos en nuestras sucursales">
        <div className="container-page text-center">
          ...
          <Link to="/sucursales" className="inline-flex items-center gap-2 bg-primary text-white font-bold px-8 py-4 rounded-xl hover:opacity-90 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
