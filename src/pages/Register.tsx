...
export default function Register() {
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center py-12 px-4 bg-slate-50">
      <SEO canonical="/register" title="Crear cuenta" noindex={true} />
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-secondary-gray/15 p-8">
            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-secondary-gray leading-snug">
                  Acepto los{' '}
                  <Link to="/terminos-y-condiciones" className="text-primary hover:underline" target="_blank">
          ...
          <p className="text-center text-sm text-secondary-gray mt-6">
            ¿Ya tenés cuenta?{' '}
            <Link to="/login" className="text-primary font-semibold hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded">
              {t('nav.login')}
            </Link>
          </p>
        </div>
