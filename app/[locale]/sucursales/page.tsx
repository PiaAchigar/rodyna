...
function BranchCard({
  ...
  return (
    <article
      className={`bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer border-2 ${
    ...
    >
      ...
      <div className="p-5 flex flex-col justify-between">
        <div>
          ...
          <ul className="space-y-1.5 text-xs text-secondary-gray">
            ...
            <li className="flex items-start gap-1.5">
              ...
              <div>
                ...
                <p>
                  Sáb: {branch.hours.saturday} · Dom: {branch.hours.sunday}
                </p>
              </div>
            </li>
          </ul>
          ...
          {/* Obras Sociales */}
          <div className="mt-3">
            <p className="text-[10px] font-bold text-main-dark uppercase tracking-wide mb-1.5">
              Obras sociales:
            </p>
            <div className="flex flex-wrap gap-1">
              {branch.healthInsurances.map((os) => (
                <span
                  key={os}
                  className="text-[10px] bg-primary/10 text-main-dark px-1.5 py-0.5 rounded-full font-medium"
                >
                  {os}
                </span>
              ))}
    ...
    <>
      ...
      <section className="bg-main-dark text-white py-14" aria-labelledby="sucursales-page-title">
        <div className="container-page">
          <h1 id="sucursales-page-title" className="text-4xl font-black mb-2">
            {t('branches.title')}
          </h1>
      ...
      <div className="bg-primary text-white text-center text-sm font-medium py-2">
        Mostrando mapa de: <strong>{selectedBranch.name}</strong> — hacé clic en otra sucursal para
        cambiar
      </div>
        ...
        <div className="container-page">
          ...
          <div className="mt-10 bg-primary/10 border border-primary/20 rounded-2xl p-6 text-center">
            ...
            <p className="text-sm text-secondary-gray">
              Consultá la lista de obras sociales disponible en cada sucursal. Las coberturas pueden
