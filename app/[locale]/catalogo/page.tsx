  ...
  return (
    <article className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
      <Link
        ...
        className="block relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-t-2xl"
      >
        {hasPromo && (
      ...
      <div className="p-4">
        <p className="text-xs text-secondary-gray font-medium uppercase tracking-wide mb-0.5">
          {product.brand}
        </p>
        <Link
          href={`/producto/${product.slug}`}
        ...
        <div className="flex items-center justify-between">
          <div>
            {hasPromo && (
              <p className="text-xs text-secondary-gray line-through">
                {formatPrice(product.price, currency)}
              </p>
            )}
            <p className="text-base font-black text-main-dark">
...
function EmptyState() {
  return (
    <div className="col-span-full py-20 text-center">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-16 w-16 text-secondary-gray/30 mx-auto mb-4"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        aria-hidden="true"
      ...
      <p className="text-sm text-secondary-gray/60 mt-1">
        Probá con otros términos o eliminá los filtros.
      </p>
    </div>
  )
}
...
export default function CatalogoPage() {
  ...
  return (
    <>
      {/* Hero de página */}
      <section
        className="bg-white border-b border-secondary-gray/15 py-8"
        aria-labelledby="catalog-title"
      >
        <div className="container-page">
          <nav
            aria-label="Breadcrumb"
            className="text-sm text-secondary-gray mb-3 flex items-center gap-2"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <h1
                id="catalog-title"
                className="text-4xl font-black text-main-dark"
              >
                Farmacia y Bienestar
              </h1>
              <p className="text-secondary-gray mt-1">
                Encontrá los mejores productos para tu salud y cuidado personal.
              </p>
            </div>
      ...
      {/* Categorías nav */}
      <nav
        className="bg-white border-b border-secondary-gray/15 sticky top-16 md:top-20 z-10 overflow-x-auto"
      ...
      <div className="container-page py-8">
        <div className="flex gap-8">
          ...
          <aside className="hidden lg:block w-60 shrink-0" aria-label="Filtros">
            <h2 className="text-sm font-bold uppercase tracking-wider text-main-dark mb-5">
              Filtros
            </h2>
            ...
            <div className="mb-6">
              <label
                ...
                className="text-xs font-bold text-secondary-gray uppercase tracking-wide block mb-2"
              >
                Buscar
              </label>
              <div className="relative">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-secondary-gray"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  aria-hidden="true"
            ...
            {/* Categorías */}
            <div>
              <p className="text-xs font-bold text-secondary-gray uppercase tracking-wide mb-3">
                Categorías
              </p>
                    ...
                    <button
                      ...
                      className={`w-full text-left text-sm px-3 py-2 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                        selectedCategory === cat
                          ...
                          : 'text-secondary-gray hover:bg-slate-100'
                      }`}
                    >
                      {cat}
                    </button>
          ...
          <div className="flex-1 min-w-0">
            ...
            {sidebarOpen && (
              <div className="lg:hidden bg-white border border-secondary-gray/20 rounded-xl p-4 mb-5">
                <p className="text-xs font-bold text-secondary-gray uppercase tracking-wide mb-3">
                  Categorías
                </p>
                    ...
                    <button
                      ...
                      className={`text-sm px-3 py-1.5 rounded-full border transition-colors ${
                        selectedCategory === cat
                          ...
                          : 'border-secondary-gray/30 text-secondary-gray hover:border-primary'
                      }`}
                    >
                      {cat}
                    </button>
            ...
            {/* Contador resultados */}
            <p
              className="text-sm text-secondary-gray mb-4"
              aria-live="polite"
            >
