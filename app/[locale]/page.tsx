...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Farmacias online con envío rápido y precios competitivos. Dermocosmética, perfumería y OTC en CABA y AMBA.',
    url: 'https://www.rodynafarmacias.com.ar',
    images: [{ url: '/assets/cruz_color_claro.svg', width: 1200, height: 630, alt: 'Rodyna Farmacias' }],
  },
  alternates: {
    canonical: 'https://www.rodynafarmacias.com.ar',
  },
}
      ...
      <section id="sucursales" className="py-20 bg-white" aria-labelledby="sucursales-title">
        <div className="container-page">
          <div className="flex items-center justify-between mb-10 flex-wrap gap-4">
            ...
            <Link
              href="/sucursales"
              className="text-sm font-semibold text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded flex items-center gap-1"
            >
              {t('branches.seeAll')}
      ...
      <section className="py-20 bg-main-dark text-white" aria-labelledby="horarios-title">
        <div className="container-page grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="w-full h-96 bg-white/5 rounded-2xl overflow-hidden border border-white/10">
              <iframe
                ...
                title="Ubicación Rodyna Caseros"
              />
            </div>
          </div>
        </div>
